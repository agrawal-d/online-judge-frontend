...
import { selectGlobalErrors, setGlobalErrors } from './reducers/globalErrorsReducer';
	...
	return (
		<div className="App">
			...
			<Modal show={show} onHide={handleClose}>
				...
				<Modal.Footer>
					<Button variant="secondary" className="float-left" onClick={() => window.location.reload()}>
						Reload app
					</Button>
