...
export default function AdminDashboard() {
  ...
  const [allTAs,setAllTAs] = useState<User[] | null>(null);
  ...
  function updateAllTAs(){
    axios.get("/users/tas").then((res) => {
      const data = res.data;
  ...
  function createNewTA(){
    ...
    axios.post("/admin/make-ta",{email : newTAEmail})
    .then((res) => {
      const data = res.data;
      console.log(data);
      if (data.errors) {
  ...
  const renderTAList = () => {
    ...
    if (allTAs.length === 0) {
      p.push(<Alert variant="primary">No TAs yet.</Alert>);
    }
          ...
          <Row>
            ...
            <Card body>
              ...
              <Card body>
                ...
                <Button onClick={createNewTA}>Save</Button>
              </Card>
              </Col>
          </Row>
        </Container>
